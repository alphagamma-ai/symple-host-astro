...
1. Click **+ New Property**.![](/uploads/adding-a-listing-manually/01.png)
2. Select **Manual** to create from scratch.![](/uploads/adding-a-listing-manually/02.png)
...
You need the **can\_manage\_listings** permission. Ask your account owner to grant it under **Settings** → **Team Members**.
