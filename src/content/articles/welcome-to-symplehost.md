...
## Who Is SympleHost For?

- **Solo hosts** managing one or a handful of listings
- **Property managers** running multiple properties or units
- **Teams** — cleaners, co-hosts, booking coordinators — who need shared access

Whether you're running a beachside villa or a portfolio of city apartments, SympleHost scales with you.

---

## A Quick Tour of the Platform

When you log in, you'll see a **sidebar on the left**. This is how you navigate everything. Here's what each section does:
...
2. **Add or import your first listing** — If you already have Airbnb, import that listing first. Use Manual only if you are starting fresh or running a fully direct-booking business. After the listing exists, connect Booking.com, Expedia, Agoda, VRBO, and other OTAs through Channel Manager.
