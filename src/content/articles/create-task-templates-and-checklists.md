...
description: 'Build reusable job templates for turnovers, inspections, maintenance, restocking, and other repeatable operating procedures.'
...
1. Go to **Operations → Job Templates**.
...
The checklist is copied into that task so the assignee can complete it step by step.
