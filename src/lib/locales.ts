...
export const uiCopy = {
  en: {
    ...
    searchHeroPlaceholder: 'Search guides, FAQs, and videos...',
    searchPrompt: 'Search articles, FAQs, videos, and webinars.',
  ...
  jp: {
    ...
    searchHeroPlaceholder: 'ガイド・FAQ・動画を検索...',
    searchPrompt: '記事、FAQ、動画、ウェビナーを検索できます。',
    searchCategoryFilter: 'カテゴリー',
    questions: '件の質問',
  ...
  id: {
    ...
    searchHeroPlaceholder: 'Cari panduan, FAQ, dan video...',
    searchPrompt: 'Cari artikel, FAQ, video, dan webinar.',
    searchCategoryFilter: 'Kategori',
...
export const sectionCopy: Record<Locale, Record<string, string>> = {
  ...
  jp: {
    ...
    'Connect your listings': 'リスティング接続',
  ...
  id: {
    ...
    'Connect your listings': 'Hubungkan listing Anda',
